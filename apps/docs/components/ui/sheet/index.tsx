...
export function SheetCloseX({
  ...
  return (
    <BaseDrawer.Close
      className={cx("sh-ui-sheet__close", className)}
      aria-label="닫기"
      {...props}
    >
      {children ?? "×"}
...
export function SheetHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cx("sh-ui-sheet__header", className)} {...props} />;
}

/** Sheet 콘텐츠 하단의 액션 버튼 영역. 보통 [취소, 확인] 순서. */
export function SheetFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cx("sh-ui-sheet__footer", className)} {...props} />;
}
    ...
    return (
      <BaseDrawer.Portal container={container}>
        ...
        <BaseDrawer.Popup
          ref={ref}
          data-side={side}
          className={cx("sh-ui-sheet__content", className)}
          {...props}
        >
          {children}
        </BaseDrawer.Popup>
...
>(function SheetTitle({ className, ...props }, ref) {
  return (
    <BaseDrawer.Title
      ref={ref}
      className={cx("sh-ui-sheet__title", className)}
      {...props}
    />
  );
});
...
>(function SheetDescription({ className, ...props }, ref) {
  return (
    <BaseDrawer.Description
      ref={ref}
      className={cx("sh-ui-sheet__description", className)}
      {...props}
    />
  );
});
