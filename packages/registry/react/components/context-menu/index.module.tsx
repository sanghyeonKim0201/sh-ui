...
>(function ContextMenuTrigger({ className, ...props }, ref) {
  return (
    <BaseContextMenu.Trigger
      ref={ref}
      className={cn(styles.cm__trigger, className)}
      {...props}
    />
  );
});
...
>(function ContextMenuContent({ className, children, container, ...props }, ref) {
  return (
    <BaseContextMenu.Portal container={container}>
      <BaseContextMenu.Positioner className={styles.cm__positioner}>
        <BaseContextMenu.Popup
          ref={ref}
          className={cn(styles.cm__content, className)}
          {...props}
        >
          {children}
        </BaseContextMenu.Popup>
...
>(function ContextMenuItem({ className, ...props }, ref) {
  return (
    <BaseContextMenu.Item
      ref={ref}
      className={cn(styles.cm__item, className)}
      {...props}
    />
  );
});
...
>(function ContextMenuCheckboxItem({ className, children, ...props }, ref) {
  return (
    <BaseContextMenu.CheckboxItem
      ref={ref}
      className={cn(styles.cm__item, styles["cm__item--check"], className)}
      {...props}
    >
      <span className={styles["cm__item-indicator"]} aria-hidden>
        <BaseContextMenu.CheckboxItemIndicator>
          <CheckIcon />
        </BaseContextMenu.CheckboxItemIndicator>
      </span>
      <span className={styles["cm__item-text"]}>{children}</span>
    </BaseContextMenu.CheckboxItem>
  );
});
...
>(function ContextMenuGroup({ className, ...props }, ref) {
  return (
    <BaseContextMenu.Group
      ref={ref}
      className={cn(styles.cm__group, className)}
      {...props}
    />
  );
});
...
>(function ContextMenuLabel({ className, ...props }, ref) {
  return (
    <BaseContextMenu.GroupLabel
      ref={ref}
      className={cn(styles.cm__label, className)}
      {...props}
    />
  );
});
...
>(function ContextMenuSeparator({ className, ...props }, ref) {
  return (
    <div
      ...
      className={cn(styles.cm__separator, className)}
      {...props}
    />
  );
});
...
>(function ContextMenuSubTrigger({ className, children, ...props }, ref) {
  return (
    <BaseContextMenu.SubmenuTrigger
      ref={ref}
      className={cn(styles.cm__item, styles["cm__sub-trigger"], className)}
      {...props}
    >
      <span className={styles["cm__item-text"]}>{children}</span>
      <span className={styles["cm__sub-arrow"]} aria-hidden>
        <ChevronRightIcon />
      </span>
    </BaseContextMenu.SubmenuTrigger>
  );
