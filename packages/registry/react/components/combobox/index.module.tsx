...
>(function ComboboxItem({ className, children, ...props }, ref) {
  return (
    <BaseCombobox.Item
      ref={ref}
      className={cn(styles.combobox__item, className)}
      {...props}
    >
      <BaseCombobox.ItemIndicator className={styles["combobox__item-indicator"]}>
        <CheckIcon />
      </BaseCombobox.ItemIndicator>
      <span className={styles["combobox__item-text"]}>{children}</span>
    </BaseCombobox.Item>
  );
});
...
>(function ComboboxGroupLabel({ className, ...props }, ref) {
  return (
    <BaseCombobox.GroupLabel
      ref={ref}
      className={cn(styles["combobox__group-label"], className)}
      {...props}
    />
  );
});
...
>(function ComboboxChip({ className, ...props }, ref) {
  return (
    <BaseCombobox.Chip
      ref={ref}
      className={cn(styles.combobox__chip, className)}
      {...props}
    />
  );
});
...
>(function ComboboxChipRemove({ className, children, ...props }, ref) {
  return (
    <BaseCombobox.ChipRemove
      ref={ref}
      className={cn(styles["combobox__chip-remove"], className)}
      {...props}
    >
      {children ?? "×"}
    </BaseCombobox.ChipRemove>
